...
| ncfs\_endpoint\_csv | The list of cluster endpoints in csv for ncfs event service | `string` | `""` | no |
...
| policy\_update\_endpoint\_csv | The list of cluster endpoints in csv for policy update service | `string` | `""` | no |
